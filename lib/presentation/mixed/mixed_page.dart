...
class MixedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: GetBuilder<MixedDataController>(builder: (controller) {
          return Column(
            children: [
              Expanded(
  ...
  Widget _buildForm(MixedDataController vaccineController, context) {
    return Container(
      width: double.maxFinite,
      padding: EdgeInsets.only(
        left: 49.h,
  ...
  Widget dropdown(MixedDataController controller) {
    return DecoratedBox(
  ...
  Widget _buildPopulationOfSheep(MixedDataController vaccineController) {
    return Padding(
      padding: EdgeInsets.only(left: 1.h),
  ...
  Widget _buildPopulationOfGoats(MixedDataController vaccineController) {
    return Padding(
      padding: EdgeInsets.only(left: 1.h),
      child: CustomTextFormField(
        textInputType: TextInputType.phone,
  ...
  Widget _buildNumberOfGoatHerds(MixedDataController vaccineController) {
    return Padding(
      padding: EdgeInsets.only(left: 1.h),
      child: CustomTextFormField(
        textInputType: TextInputType.phone,
  ...
  Widget _buildNumberOfSheepHerds(MixedDataController vaccineController) {
    return Padding(
      padding: EdgeInsets.only(left: 1.h),
      child: CustomTextFormField(
        textInputType: TextInputType.phone,
  ...
  Widget _buildPhone(MixedDataController vaccineController, context) {
    return Padding(
      padding: EdgeInsets.only(left: 2.h),
  ...
  Widget _addOutBreak(MixedDataController vaccineController) {
    return Card(
