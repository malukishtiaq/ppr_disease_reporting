...
class GoatPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: GetBuilder<GoatDataController>(builder: (controller) {
          return Column(
            children: [
              Expanded(
  ...
  Widget _buildForm(GoatDataController vaccineController, context) {
    return Container(
      width: double.maxFinite,
      padding: EdgeInsets.only(
        left: 49.h,
  ...
  Widget _addOutBreak(GoatDataController vaccineController) {
    return Card(
